...
import {ADD_VIDEO, ADD_VIDEOS, REMOVE_ALL_VIDEOS, REMOVE_VIDEO, VIDEO_COMPLETE, VIDEO_PROGRESS} from "./types";
import _ from "lodash";

// Info: Communicate to MainWindow process that videos
...
// Info: Communicate to MainWindow that the user wants
...
// Info: Open the folder that the newly created video
// exists in
export const showInFolder = outputPath => dispatch => {
    ipcRenderer.send("showInFolder", outputPath);
};
